...
//	}
	...
	@PostMapping("/list")
	@ResponseBody
	public Product addToList(@RequestBody Product product) {	
	...
	@ResponseBody
	public void removeFromList(@PathVariable int id) {
		//System.out.println(cart.removeProductById(id));
		cart.removeProductById(id);
	}
	
	@PutMapping("/list/{id}")
	@ResponseBody
	public Product updateFromList(@RequestBody Product product,@PathVariable int id) {
